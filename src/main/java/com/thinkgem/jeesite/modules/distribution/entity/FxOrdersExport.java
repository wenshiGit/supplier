...
/**
 * fx_orders_exportEntity
 * @author MaoNian
 * @version 2019-04-28
 */
public class FxOrdersExport extends DataEntity<FxOrdersExport> {
	
	private static final long serialVersionUID = 1L;
	private Long orderId;		// order_id
	private String abnState;		// abn_state
	...
	private Long factChannelId;		// fact_channel_id
	private String factChannelName;		// fact_channel_name
	...
	private String orderSrc;		// 订单来源，1淘宝， 2京东 默认1
	
	public FxOrdersExport() {
		super();
	}

	public FxOrdersExport(String id){
		super(id);
	}
	...
	@Length(min=0, max=11, message="abn_state长度必须介于 0 和 11 之间")
	...
	public Long getFactChannelId() {
		return factChannelId;
	}

	public void setFactChannelId(Long factChannelId) {
		this.factChannelId = factChannelId;
	}
	
	@Length(min=0, max=100, message="fact_channel_name长度必须介于 0 和 100 之间")
	public String getFactChannelName() {
		return factChannelName;
	}

	public void setFactChannelName(String factChannelName) {
		this.factChannelName = factChannelName;
	}
	...
	@Length(min=0, max=100, message="uuid长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=6, message="订单来源，1淘宝， 2京东 默认1长度必须介于 0 和 6 之间")
